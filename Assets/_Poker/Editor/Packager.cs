...
public class Packager {
	...
	static string luaPath = AppDataPath + "/StreamingAssets/lua/";
	static string[] luaPaths = { 
		AppDataPath + string.Format("/{0}/lua/",AppConst.AppName), 
    ...
    static UnityEngine.Object LoadAsset(string file) {
		...
		return AssetDatabase.LoadMainAssetAtPath(AppConst.AppRootAsset +"/Examples/Builds/" + file);
    }
...
//        }
    ...
    static void BuildLuaBundles() {
		...
		CopyLuaBytesFiles(AppConst.Root + "/ToLua/Lua", streamDir);
    ...
    static void BuildFileIndex() {
        ...
        for (int i = 0; i < files.Count; i++) {
			...
			if (ext.Contains(".meta") || ext.Contains(".DS_Store")) continue;
