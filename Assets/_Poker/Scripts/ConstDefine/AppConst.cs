...
namespace LuaFramework {
    public class AppConst {
        ...
        /// 关闭，否则会出现一些错误。
        /// </summary>
		public static readonly bool ExampleMode = true;                       //例子模式 
		...
		public const string Assets = "Assets/";               //应用程序名称
        public const string AppName = "_Poker";               //应用程序名称
		...
		public static string AppRootAsset{
			get{
