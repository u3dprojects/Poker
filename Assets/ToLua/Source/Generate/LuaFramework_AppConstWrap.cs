...
public class LuaFramework_AppConstWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("Assets", get_Assets, null);
		...
		L.RegVar("AppRootAsset", get_AppRootAsset, null);
	...
	static int get_Assets(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.Assets);
			return 1;
		}
		catch(Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_AppRootAsset(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.AppRootAsset);
			return 1;
		}
		catch(Exception e)
		{
	...
	static int get_Root(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.Root);
			return 1;
		}
		catch(Exception e)
		{
